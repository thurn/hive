...
from hive.cost_report import estimate_claude
    ...
    *,
    ...
    for raw in sequence(fetched, "request events"):
        ...
        if quoted is not None:
            ...
            counts[reason or "unpriced_event"] += 1
    ...
    return {
        ...
        "api_errors": integer(row(errors, 1)[0], "API error count"),
        ...
        "complete_estimate_reasons": conditions,
