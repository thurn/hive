---
name: justiciar
description: Contain and repair a bounded Hive workflow incident with native tools.
---
...
When invoked as a fresh subagent to review a proposed deferral, instead apply [deferral decisions](../shared/repair.md#deferral-decisions) read-only. Independently check the latest authorization, native ownership and concrete alternatives; agree only when the extremely high bar is met. Return explicit agreement or disagreement for each named bead, the evidence and necessary resumption action. Do not implement, claim, change bead state, or spawn another deferral reviewer. This independent review is distinct from the executor's same-task recovery.
