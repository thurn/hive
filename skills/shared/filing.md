...
```sh
hive-bd --actor "$CODEX_THREAD_ID" create --title 'Scoped work' --description '...' --acceptance '...' --priority 2 --metadata "{\"hive_project\":\"example\",\"hive_origin_thread\":\"$CODEX_THREAD_ID\"}" --json
```
